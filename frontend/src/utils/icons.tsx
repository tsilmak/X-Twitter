...
export const TrashIcon = ({
  ...
  >
    <g>
      <path d="M16 6V4.5C16 3.12 14.88 2 13.5 2h-3C9.11 2 8 3.12 8 4.5V6H3v2h2v13.5C5 22.88 6.12 24 7.5 24h9c1.38 0 2.5-1.12 2.5-2.5V8h2V6h-5zm-6-1.5c0-.28.22-.5.5-.5h3c.27 0 .5.22.5.5V6h-4V4.5zm7 15c0 .28-.22.5-.5.5h-9c-.27 0-.5-.22-.5-.5V8h10v11.5zM9 10h2v8H9v-8zm4 0h2v8h-2v-8z"></path>
    </g>
  </svg>
);
...
export const CameraIcon = ({
  ...
  >
    <g>
      <path d="M9.697 3H11v2h-.697l-3 2H5c-.276 0-.5.224-.5.5v11c0 .276.224.5.5.5h14c.276 0 .5-.224.5-.5v-11c0-.276-.224-.5-.5-.5h-2.303l-3-2H13V3h1.303l3 2H19c1.381 0 2.5 1.119 2.5 2.5v11c0 1.381-1.119 2.5-2.5 2.5H5c-1.381 0-2.5-1.119-2.5-2.5v-11C2.5 6.119 3.619 5 5 5h1.697l3-2zM12 10.5c-1.105 0-2 .895-2 2s.895 2 2 2 2-.895 2-2-.895-2-2-2zm-4 2c0-2.209 1.791-4 4-4s4 1.791 4 4-1.791 4-4 4-4-1.791-4-4z"></path>
    </g>
  </svg>
);
